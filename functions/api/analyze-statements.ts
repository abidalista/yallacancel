...
/** Keep in sync with src/lib/server/jfc-skill.ts */
const JFC_SKILL_SYSTEM = `You are the Just Fucking Cancel subscription audit engine, running inside YallaCancel (Arabic-first Saudi product, mint brand — analysis logic is identical to JFC).
