...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: "دراسة تكشف ان السعودي يدفع بالمتوسط ٣٨٢ ريال شهريا على اشتراكات رقمية — وأغلبها منسية.",
...
- **فعل إشعارات البنك**: خل البنك يرسل لك إشعار مع كل عملية — كذا ما تنسى أي خصم.
...
Upload your statement to **Yalla Cancel** and we'll decode every transaction in seconds — with cancel links for each one.`,
  },
  {
    ...
    excerpt: "من الأزرار المخفية للعروض المضللة — كيف الشركات تصعب عليك الإلغاء وكيف تتغلب عليها.",
...
**المشكلة**: تلغي الاشتراك بس يحولونك لخطة أرخص بدل ما يلغون فعليا.
...
**٣. سجل كل شي**: لو الشركة رفضت تلغي، وثق المحاولة وتواصل مع هيئة الاتصالات أو وزارة التجارة.
...
Adobe Creative Cloud من أصعب الاشتراكات في الإلغاء. ليش؟ لأن أغلب الناس يشتركون في **الخطة السنوية** (اللي تدفعها شهريا) — وهذي فيها **رسوم إلغاء مبكر** تصل لـ ٥٠٪ من المتبقي.

يعني لو اشتركت في يناير وبتلغي في يونيو، ممكن تدفع رسوم إلغاء تصل لـ **٤٠٠-٦٠٠ ريال**.

## كيف تتجنب رسوم الإلغاء؟

### الطريقة الأولى: الغ في أول ١٤ يوم
...
- **شهر Netflix** → شاهد كل اللي تبيه → لغ
- **شهر Disney+** → شاهد المسلسلات الجديدة → لغ
- **شهر شاهد** → تابع المسلسلات العربية → لغ
...
لو الجواب "لا" على السؤال الأول — **الغ فورا**.
...
**الخطوة ٤**: تبدأ تنخصم منك شهريا — وما تحس إلا بعد أشهر.
...
### ٢. الغ فورا بعد التسجيل
كثير من الخدمات تخليك تلغي **بعد ما تسجل مباشرة** وتظل تستخدم التجربة المجانية للنهاية. أفضل طريقة — الغ من اليوم الأول وخل التجربة تكمل لوحدها.
...
- **"مجاني للأبد"**: بس مع مميزات محدودة جدا تخليك تحتاج تترقى
