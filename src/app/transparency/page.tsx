...
الطريقة بسيطة: ترفع كشف حسابك البنكي (PDF أو CSV)، ونحلله محليا داخل متصفحك — يعني ملفك ما يطلع من جهازك أبدا. نكتشف لك الاشتراكات، ونساعدك تقرر وش تبقيه ووش تلغيه.

ما نخزن كشوفات بنكية على سيرفراتنا. أبدا.`,
  },
  {
    icon: Package,
    title: "المنتجات",
...
ما في اشتراك شهري. ما في رسوم مخفية. تدفع مرة وحدة وبس.`,
  },
  {
    ...
    content: `كشوفاتك البنكية تتحلل وتنقرأ محليا داخل متصفحك. ما نرفعها ولا نخزنها على أي سيرفر.
